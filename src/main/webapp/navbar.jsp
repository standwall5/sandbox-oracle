  ...
  <nav class="navbar navbar-expand-md fixed-top navbar-dark blur">
    <div class="container-fluid">
      <div>
        <c:if test="${sessionScope.mode == 0}">
          <a
            ...
            href="<%=request.getContextPath()%>/newHome"
            ><img
      ...
      <ul class="navList navbar-nav ms-auto">
        ...
        <li>
          <a
            class="navi btn text-dark me-5"
            href="<%=request.getContextPath()%>/newHome"
            >Home</a
          >
        </li>
        <c:if test="${sessionScope.mode == 0}">
          <!-- mode = 0 indicates user, 1 is company -->
          <li>
            <a
              href="<%=request.getContextPath()%>/user?id=<c:out value='${sessionScope.userId}'/>"
              class="nav-link text-dark me-4"
              style="padding-right: 20px"
              ><img
                class="nav-pic"
                src="<%=request.getContextPath()%>/getImage"
                width="50px"
        ...
        <c:if test="${sessionScope.mode == 1}">
          <li>
            <a
              href="<%=request.getContextPath()%>/company?id=<c:out value='${sessionScope.companyId}'/>"
              class="nav-link text-dark me-4"
              style="padding-right: 20px"
              ><img
                class="nav-pic"
                src="<%=request.getContextPath()%>/getImageCompany"
                width="50px"
                style="position: relative; top: -10px"
            /></a>
          </li>
        ...
        <li class="nav-item dropdown">
          <a
            class="nav-link dropdown-toggle text-dark me-5"
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <c:if test="${companyID == 6}">
              <li>
                <a class="dropdown-item" href="regCompanyUser.jsp"
                  >Register Company</a
                >
              </li>
            </c:if>
