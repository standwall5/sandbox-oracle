-- Alternative PostgreSQL Setup (No Superuser Required)
-- Run this if you can connect with any PostgreSQL user

-- Create database (if you have createdb privileges)
-- CREATE DATABASE "peso-application";

-- If you can't create database, use an existing one like 'postgres'
-- Just comment out the database creation and use: \c postgres

-- Create all tables in current database
